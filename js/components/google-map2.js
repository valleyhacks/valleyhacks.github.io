...
jQuery(document).ready(function($){
  ...
  var latitude = 37.347667,
      longitude = -121.989583,
      map_zoom = 6;
  ...
  var contentString = '<div id="content">'+
    '<div id="siteNotice">'+
    '</div>'+
    '<h2 id="firstHeading" class="firstHeading">Mountain View</h2>'+
    '<div id="bodyContent">'+
    '<p>331 E. Evelyn Avenue, <br> Mountain View, CA 94041, <br> California, USA</p>'+
    '</div>'+
    '</div>';
